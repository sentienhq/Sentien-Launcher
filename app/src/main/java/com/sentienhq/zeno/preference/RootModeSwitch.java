...
public class RootModeSwitch extends SwitchPreference {
    ...
    protected void onClick() {
        if (!isChecked() && !ZenoApplication.getApplication(getContext()).getRootHandler().isRootAvailable()) {
            //show error dialog
        ...
        try {
            ZenoApplication.getApplication(getContext()).resetRootHandler(getContext());
