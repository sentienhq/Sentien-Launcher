...
import com.sentienhq.zeno.IconsHandler;
...
public class ExcludePreferenceScreen {
    ...
    public static PreferenceScreen getInstance(
        ...
        List<AppPojo> appList = ZenoApplication.getApplication(preferenceActivity).getDataHandler().getApplications();
        IconsHandler iconsHandler = ZenoApplication.getApplication(preferenceActivity).getIconsHandler();
