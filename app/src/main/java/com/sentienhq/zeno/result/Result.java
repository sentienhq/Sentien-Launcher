...
import com.sentienhq.zeno.BuildConfig;
...
public abstract class Result {
    ...
    private void launchAddToFavorites(Context context, Pojo app) {
        ...
        ZenoApplication.getApplication(context).getDataHandler().addToFavorites(app.id);
    ...
    private void launchRemoveFromFavorites(Context context, Pojo app) {
        ...
        ZenoApplication.getApplication(context).getDataHandler().removeFromFavorites(app.id);
        Toast.makeText(context, String.format(msg, app.getName()), Toast.LENGTH_SHORT).show();
    }
    ...
    void recordLaunch(Context context) {
        // Save in history
        ZenoApplication.getApplication(context).getDataHandler().addToHistory(pojo.id);
    }
