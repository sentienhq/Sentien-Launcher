package com.sentienhq.zeno.result;
...
import com.sentienhq.zeno.UIColors;
...
import com.sentienhq.zeno.ui.GoogleCalendarIcon;
import com.sentienhq.zeno.ui.ListPopup;
import com.sentienhq.zeno.utils.FuzzyScore;
import com.sentienhq.zeno.utils.SpaceTokenizer;
...
public class AppResult extends Result {
    ...
    protected ListPopup buildPopupMenu(Context context, ArrayAdapter<ListPopup.Item> adapter, final RecordAdapter parent, View parentView) {
        ...
        if (ZenoApplication.getApplication(context).getRootHandler().isRootActivated() && ZenoApplication.getApplication(context).getRootHandler().isRootAvailable()) {
    ...
    private void excludeFromHistory(Context context, AppPojo appPojo, final RecordAdapter parent) {
        ...
        ZenoApplication.getApplication(context).getDataHandler().addToExcludedFromHistory(appPojo);
        //remove from history
    ...
    private void excludeFromKiss(Context context, AppPojo appPojo) {
        ZenoApplication.getApplication(context).getDataHandler().addToExcluded(appPojo);
    ...
    private void launchEditTagsDialog(final Context context, final AppPojo app) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(context,
                android.R.layout.simple_dropdown_item_1line, ZenoApplication.getApplication(context).getDataHandler().getTagsHandler().getAllTagsAsArray());
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                ZenoApplication.getApplication(context).getDataHandler().getTagsHandler().setTags(app.id, app.getTags());
                // Show toast message
    ...
    private void hibernate(Context context, AppPojo app) {
        ...
        if (!ZenoApplication.getApplication(context).getRootHandler().hibernateApp(appPojo.packageName)) {
    ...
    public Drawable getDrawable(Context context) {
        synchronized (this) {
            ...
            if (icon == null) {
                icon = ZenoApplication.getApplication(context).getIconsHandler()
