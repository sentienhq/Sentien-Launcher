...
public class ZenoApplication extends Application {
    /**
    ...
    public static ZenoApplication getApplication(Context context) {
        return (ZenoApplication) context.getApplicationContext();
    }
