...
import com.sentienhq.zeno.forwarder.TagsMenu;
import com.sentienhq.zeno.pojo.AppPojo;
import com.sentienhq.zeno.pojo.Pojo;
import com.sentienhq.zeno.pojo.TagDummyPojo;
import com.sentienhq.zeno.preference.ExcludePreferenceScreen;
import com.sentienhq.zeno.preference.PreferenceScreenHelper;
import com.sentienhq.zeno.preference.SwitchPreference;
import com.sentienhq.zeno.searcher.QuerySearcher;
import com.sentienhq.zeno.utils.PackageManagerUtils;
...
public class SettingsActivity extends PreferenceActivity implements
    ...
    final static private String settingsRequiringRestart = "primary-color transparent-search transparent-favorites pref-rounded-list pref-rounded-bars pref-swap-zeno-button-with-menu pref-hide-circle history-hide enable-favorites-bar notification-bar-color black-notification-icons";
    ...
    private static Set<String> getFavTags(Context context) {
        ArrayList<Pojo> favoritesPojo = ZenoApplication.getApplication(context).getDataHandler()
                .getFavorites();
    ...
    private void addExcludedAppSettings() {
        final DataHandler dataHandler = ZenoApplication.getApplication(this).getDataHandler();
    ...
    private void addCustomSearchProvidersDelete(final SharedPreferences prefs) {
        ...
        multiPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                // Reload search list
                final SearchProvider provider = ZenoApplication.getApplication(SettingsActivity.this).getDataHandler().getSearchProvider();
                if (provider != null) {
                    provider.reload();
                }
                return true;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equalsIgnoreCase("available-search-providers")) {
            ...
            ZenoApplication.getApplication(this).getIconsHandler().loadIconsPack(sharedPreferences.getString(key, "default"));
            ...
            DataHandler dh = ZenoApplication.getApplication(this).getDataHandler();
    ...
    private void fixSummaries() {
        int historyLength = ZenoApplication.getApplication(this).getDataHandler().getHistoryLength();
        if (historyLength > 5) {
    ...
    private void setListPreferenceIconsPacksData(ListPreference lp) {
        IconsHandler iph = ZenoApplication.getApplication(this).getIconsHandler();
    ...
    private void addHiddenTagsTogglesInformation(SharedPreferences prefs) {
        ...
        Set<String> tagsSet = ZenoApplication.getApplication(this)
                .getDataHandler()
                .getTagsHandler()
                .getAllTagsAsSet();
