...
import com.sentienhq.zeno.broadcast.PackageAddedRemovedHandler;
import com.sentienhq.zeno.loader.LoadAppPojos;
            ...
            this.registerReceiver(new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    if (Objects.equals(intent.getAction(), Intent.ACTION_MANAGED_PROFILE_ADDED)) {
                        ...
                        ZenoApplication.getApplication(context).getDataHandler().removeFromExcluded(user);
                        ZenoApplication.getApplication(context).getDataHandler().removeFromFavorites(user);
                        AppProvider.this.reload();
                    }
                }
            }, filter);
