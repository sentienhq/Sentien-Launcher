...
public interface IProvider {
     ...
     * <p>
     * `"fr.sentienhq.summon.LOAD_OVER"` will be emitted once the reload is complete. The data provider
     ...
     * `"fr.sentienhq.summon.LOAD_OVER"` intent for notification of when the provider is ready.
     *
