...
import com.sentienhq.zeno.searcher.QueryInterface;
...
import com.sentienhq.zeno.utils.SystemUiVisibilityHelper;
...
public class MainActivity extends Activity implements QueryInterface, KeyboardScrollHider.KeyboardHandler, View.OnTouchListener, Searcher.DataObserver {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ZenoApplication.getApplication(this).initDataHandler();
    ...
    protected void onResume() {
        ...
        if (ZenoApplication.getApplication(this).getDataHandler().allProvidersHaveLoaded) {
            displayLoader(false);
            onFavoriteChange();
        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        // Hide kissbar when coming back to zeno
        if (isViewingAllApps()) {
            displayKissBar(false);
        }
    ...
    public void onMenuButtonClicked(View menuButton) {
        // When the zeno bar is displayed, the button can still be clicked in a few areas (due to favorite margin)
    ...
    public void onLauncherButtonClicked(View launcherButton) {
        // Display or hide the zeno bar, according to current view tag (showMenu / hideMenu).
