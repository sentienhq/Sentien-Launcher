...
public class LoadAppPojos extends LoadPojos<AppPojo> {
    ...
    protected ArrayList<AppPojo> doInBackground(Void... params) {
        ...
        Set<String> excludedAppList = LauncherApplication.getApplication(ctx).getDataHandler().getExcluded();
        Set<String> excludedFromHistoryAppList = LauncherApplication.getApplication(ctx).getDataHandler().getExcludedFromHistory();
