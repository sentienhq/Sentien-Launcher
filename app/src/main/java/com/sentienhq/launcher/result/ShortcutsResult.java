...
public class ShortcutsResult extends Result {
    ...
    private void launchEditTagsDialog(final Context context, final ShortcutsPojo pojo) {
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                LauncherApplication.getApplication(context).getDataHandler().getTagsHandler().setTags(pojo.id, pojo.getTags());
                // Show toast message
    ...
    private void launchUninstall(Context context, ShortcutsPojo shortcutPojo) {
        DataHandler dh = LauncherApplication.getApplication(context).getDataHandler();
        if (dh != null) {
