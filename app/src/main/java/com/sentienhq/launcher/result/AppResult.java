...
import com.sentienhq.launcher.notification.NotificationListener;
import com.sentienhq.launcher.pojo.AppPojo;
import com.sentienhq.launcher.ui.GoogleCalendarIcon;
...
public class AppResult extends Result {
    ...
    protected ListPopup buildPopupMenu(Context context, ArrayAdapter<ListPopup.Item> adapter, final RecordAdapter parent, View parentView) {
        ...
        if (LauncherApplication.getApplication(context).getRootHandler().isRootActivated() && LauncherApplication.getApplication(context).getRootHandler().isRootAvailable()) {
    ...
    private void excludeFromHistory(Context context, AppPojo appPojo, final RecordAdapter parent) {
        ...
        LauncherApplication.getApplication(context).getDataHandler().addToExcludedFromHistory(appPojo);
        //remove from history
    ...
    private void excludeFromKiss(Context context, AppPojo appPojo) {
        LauncherApplication.getApplication(context).getDataHandler().addToExcluded(appPojo);
    ...
    private void launchEditTagsDialog(final Context context, final AppPojo app) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(context,
                android.R.layout.simple_dropdown_item_1line, LauncherApplication.getApplication(context).getDataHandler().getTagsHandler().getAllTagsAsArray());
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                LauncherApplication.getApplication(context).getDataHandler().getTagsHandler().setTags(app.id, app.getTags());
                // Show toast message
    ...
    private void hibernate(Context context, AppPojo app) {
        ...
        if (!LauncherApplication.getApplication(context).getRootHandler().hibernateApp(appPojo.packageName)) {
    ...
    public Drawable getDrawable(Context context) {
        synchronized (this) {
            ...
            if (icon == null) {
                icon = LauncherApplication.getApplication(context).getIconsHandler()
