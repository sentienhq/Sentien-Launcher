...
import com.sentienhq.launcher.forwarder.TagsMenu;
...
import com.sentienhq.launcher.preference.ExcludePreferenceScreen;
import com.sentienhq.launcher.preference.PreferenceScreenHelper;
import com.sentienhq.launcher.preference.SwitchPreference;
...
public class SettingsActivity extends PreferenceActivity implements
    ...
    final static private String settingsRequiringRestart = "primary-color transparent-search transparent-favorites pref-rounded-list pref-rounded-bars pref-swap-sentien-button-with-menu pref-hide-circle history-hide enable-favorites-bar notification-bar-color black-notification-icons";
    ...
    private static Set<String> getFavTags(Context context) {
        ArrayList<Pojo> favoritesPojo = LauncherApplication.getApplication(context).getDataHandler()
                .getFavorites();
    ...
    private void addExcludedAppSettings() {
        final DataHandler dataHandler = LauncherApplication.getApplication(this).getDataHandler();
    ...
    private void addCustomSearchProvidersDelete(final SharedPreferences prefs) {
        ...
        multiPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                // Reload search list
                final SearchProvider provider = LauncherApplication.getApplication(SettingsActivity.this).getDataHandler().getSearchProvider();
                if (provider != null) {
                    provider.reload();
                }
                return true;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equalsIgnoreCase("available-search-providers")) {
            ...
            LauncherApplication.getApplication(this).getIconsHandler().loadIconsPack(sharedPreferences.getString(key, "default"));
            ...
            DataHandler dh = LauncherApplication.getApplication(this).getDataHandler();
    ...
    private void fixSummaries() {
        int historyLength = LauncherApplication.getApplication(this).getDataHandler().getHistoryLength();
        if (historyLength > 5) {
    ...
    private void setListPreferenceIconsPacksData(ListPreference lp) {
        IconsHandler iph = LauncherApplication.getApplication(this).getIconsHandler();
    ...
    private void addHiddenTagsTogglesInformation(SharedPreferences prefs) {
        ...
        Set<String> tagsSet = LauncherApplication.getApplication(this)
                .getDataHandler()
                .getTagsHandler()
                .getAllTagsAsSet();
