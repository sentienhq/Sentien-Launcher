...
import com.sentienhq.launcher.IconsHandler;
...
public class ExcludePreferenceScreen {
    ...
    public static PreferenceScreen getInstance(
        ...
        List<AppPojo> appList = LauncherApplication.getApplication(preferenceActivity).getDataHandler().getApplications();
        IconsHandler iconsHandler = LauncherApplication.getApplication(preferenceActivity).getIconsHandler();
