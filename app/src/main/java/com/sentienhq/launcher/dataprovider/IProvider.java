...
public interface IProvider {
     ...
     * <p>
     * `"com.sentienhq.summon.LOAD_OVER"` will be emitted once the reload is complete. The data provider
     ...
     * `"com.sentienhq.summon.LOAD_OVER"` intent for notification of when the provider is ready.
     *
